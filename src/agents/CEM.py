...
class CEM:
    def __init__(self, env_id, episode_nr, step_nr, heatmap_cmap, heatmap_labels, heatmap_interp,
                 ...
                 lambda_omega=1e-3, epoch_nr=500, seed=None, out_path="", use_behavioral=False):    
        """
    ...
    def compute_entropy(self, behavioral_policy, target_policy, states, actions, distances, indices):
