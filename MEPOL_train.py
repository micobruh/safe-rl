...
#           lambda_policy = 1e-5, episode_nr = 8, step_nr = 500, epoch_nr = 50,
#           heatmap_every = 25, heatmap_cmap = 'Blues', 
#           heatmap_labels = ('X', 'Y'), heatmap_interp = 'spline16',
#           seed = 0, out_path = "result/SafetyPointGoal1/MEPOL")
# obj.train()

# MEPOL(env_id = "MountainCar-v0", k = 4, delta = 0.5, max_off_iters = 30,
#           use_backtracking = 1, backtrack_coeff = 2, max_backtrack_try = 10, eps = 1e-5,
#           lambda_policy = 1e-4, episode_nr = 8, step_nr = 400, epoch_nr = 300,
#           heatmap_every = 25, heatmap_cmap = 'Blues', 
...
obj = CEM(env_id = "MountainCarContinuous-v0", k = 4, delta = 0.5, max_off_iters = 30,
          ...
          lambda_policy = 1e-4, lambda_value = 1e-4, lambda_omega = 1e-2, episode_nr = 8, 
          step_nr = 400, epoch_nr = 2, heatmap_every = 25, heatmap_cmap = 'Blues', 
          heatmap_labels = ('Position', 'Velocity'), heatmap_interp = 'spline16',
...
# obj = MEPOL(env_id = "MountainCarContinuous-v0", k = 4, delta = 0.5, max_off_iters = 30,
#           use_backtracking = 1, backtrack_coeff = 2, max_backtrack_try = 10, eps = 1e-5,
#           lambda_policy = 1e-4, episode_nr = 8, step_nr = 400, epoch_nr = 5,
#           heatmap_every = 25, heatmap_cmap = 'Blues', 
#           heatmap_labels = ('Position', 'Velocity'), heatmap_interp = 'spline16',
#           seed = 0, out_path = "results/testing")
# obj.train()
